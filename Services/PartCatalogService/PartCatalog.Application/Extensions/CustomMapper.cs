...
public class CustomMapper : Profile
{
    public CustomMapper()
    {
        ...
        CreateMap<CreatePartDto, Part>()
            .ForMember(d => d.PartId, opt => opt.Ignore()) // Ignore PartId - will be generated by EF
            .ForMember(d => d.Status, opt => opt.MapFrom(s =>
                s.Status == null
                    ? ActiveStatus.ACTIVE   // fallback mặc định
                    : ParseEnumOrDefault(s.Status, ActiveStatus.ACTIVE)))
        ...
        // CreateMap<Part, PartDto>().ReverseMap(); // Commented out to avoid overriding CreatePartDto -> Part mapping
        // ===== Package =====
